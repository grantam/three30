...
We check the assumptions with this new model and find that the assumption of linearity is satisfied, the errors are not perfectly normal, but they are the most normal errors of all our models. The model is mostly homogenous, it is free of outliars, and without multicollinearity.  
