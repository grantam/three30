...
dat <- left_join(dat, vparty, by = c("year", "v2paid")) %>%
  select(COWcode.x, country_name.x, year, v2x_polyarchy, v2elvaptrn, v2eltrnout, v2eltype_0, v2eltype_6, v2elcomvot, v2elparlel, v2xpa_antiplural, v2pavote, v2paseatshare, v2paelcont, v2papariah, piendla, psla)
